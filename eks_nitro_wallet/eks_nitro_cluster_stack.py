...
class EksNitroWalletStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        self._create_private_link(vpc=vpc, services=["DYNAMODB", "KMS", "ECR", "S3"])
        ...
        cluster = eks.Cluster(
            self,
            "nitro-eks-cluster",
            # custom kubernetes version requires a region specific custom ami - see launchtemplate definition above
